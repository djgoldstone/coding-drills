...
function totalBill(preTaxAndTipAmount) {
  // your code here
  var subTotal = preTaxAndTipAmount + (preTaxAndTipAmount * .095);
  var totalWithTip = subTotal + (preTaxAndTipAmount * .15);
  return totalWithTip;
